...
client.on('messageCreate', async message => {
	...
	if (
		...
		message.channelId === '1220511552721911958' // Placeholder: your specific channel ID for commands.
	) {
		...
		try {
			...
			const channel = await message.guild.channels.create({
				...
				parent: '1220511484585709738', // Placeholder: parent category ID for organizing channels.
